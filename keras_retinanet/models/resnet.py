...
def resnet_retinanet(num_classes, pyramid_feature_size, classification_feature_size, regression_feature_size, backbone='resnet50', inputs=None, modifier=None, **kwargs):
    ...
    return retinanet.retinanet(inputs=inputs, num_classes=num_classes, backbone_layers=resnet.outputs[1:], pyramid_feature_size=pyramid_feature_size, classification_feature_size=classification_feature_size, regression_feature_size=regression_feature_size, **kwargs)
